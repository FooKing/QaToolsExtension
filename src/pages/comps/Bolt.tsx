...
export default function Panel(): JSX.Element {
    return (
        <div className="flex items-start">
            <ul className="nav overflow-auto nav-tabs border-r-2 flex flex-col flex-wrap list-none pl-0 mr-4" id="tabs-tabVertical"
                role="tablist">
                <li className="nav-item flex-grow text-center" role="presentation">
                    <a href="#tabs-homeVertical" className="nav-link
          block
          font-medium
          text-xs
          leading-tight
